...
console.log(`Index of element 6 --> ${indexOf6}`);
...
console.log(`Traversing array using for loop Reverse Order`);
...
console.log(`Even Position/Index Number array using for loop`);
for (let index = 0; index < arrayOfNumbers.length; index++) {
  if (index % 2 == 0) {
    const element = arrayOfNumbers[index];
    console.log(element);
...
console.log(`Odd Position/Index Number array using for loop`);
for (let index = 0; index < arrayOfNumbers.length; index++) {
  if (index % 2 == 1) {
    const element = arrayOfNumbers[index];
    console.log(element);
